        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <a href="#" className="hover:opacity-80 transition" title="RSS">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19.199 24H4.801C2.169 24 0 21.841 0 19.199V4.801C0 2.169 2.168 0 4.801 0h14.398C21.829 0 24 2.169 24 4.801v14.398C24 21.831 21.831 24 19.199 24zM8.905 18a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm3.863-3.863a5.25 5.25 0 110-7.425 5.25 5.25 0 010 7.425zm4.052-7.862a9.75 9.75 0 110-13.776 9.75 9.75 0 010 13.776z"/>
              </svg>
            </a>
          </div>
        </div>
      ...
      <header className="bg-white border-b border-[#eeeeee]">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8 items-center">
            <Link href="/" className="text-[#333] hover:text-[#2054a8] font-medium text-sm transition">
              HOME
            </Link>
            <Link href="/profile" className="text-[#333] hover:text-[#2054a8] font-medium text-sm transition">
              プロフィール
            </Link>
            <Link href="/achievements" className="text-[#333] hover:text-[#2054a8] font-medium text-sm transition">
              実績
            </Link>
            <Link href="/news" className="text-[#333] hover:text-[#2054a8] font-medium text-sm transition">
              ニュース一覧
            </Link>
            <Link href="/policy" className="text-[#333] hover:text-[#2054a8] font-medium text-sm transition">
              目指す政策
            </Link>
          </nav>
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden bg-white border-t border-[#eeeeee]">
            <div className="max-w-6xl mx-auto px-4 py-4 flex flex-col gap-2">
              <Link
                href="/"
                className="text-[#333] hover:text-[#2054a8] font-medium text-sm py-2 transition"
