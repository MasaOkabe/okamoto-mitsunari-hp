...
export function Footer() {
  return (
    <footer className="bg-[#fdfdfd] text-[#333] text-sm border-t border-[#eeeeee]">
      <div className="max-w-[1296px] mx-auto px-12 py-16">
        ...
        {/* Office Info */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12 pb-12 border-b border-[#eeeeee]">
          <div>
            <p className="font-bold text-[#333] mb-3 text-base">国会事務所</p>
            <p className="text-[#666] text-sm leading-relaxed">〒100-8981 東京都千代田区永田町2-2-1</p>
            <p className="text-[#666] text-sm leading-relaxed">衆議院第一議員会館511号</p>
            <p className="text-[#666] text-sm mt-2">TEL: 03-3508-7147</p>
          </div>
          <div>
            <p className="font-bold text-[#333] mb-3 text-base">地元事務所</p>
            <p className="text-[#666] text-sm leading-relaxed">〒116-0013 東京都荒川区西日暮里5-17-3</p>
            <p className="text-[#666] text-sm leading-relaxed">NISHINIPPORIビル3F</p>
            <p className="text-[#666] text-sm mt-2">TEL: 03-5604-5923</p>
          </div>
        </div>

        {/* Navigation links */}
        <div className="mb-10 pb-10 border-b border-[#eeeeee]">
          <nav className="flex flex-wrap gap-6 text-[#666]">
            <Link href="/" className="hover:text-[#2054a8] transition">HOME</Link>
            <Link href="/profile" className="hover:text-[#2054a8] transition">プロフィール</Link>
            <Link href="/achievements" className="hover:text-[#2054a8] transition">実績</Link>
            <Link href="/news" className="hover:text-[#2054a8] transition">ニュース一覧</Link>
            <Link href="/policy" className="hover:text-[#2054a8] transition">目指す政策</Link>
            <Link href="/inquiry" className="hover:text-[#2054a8] transition">お問合せ</Link>
          </nav>
        </div>
        ...
        <div className="mb-10 pb-10 border-b border-[#eeeeee]">
          <div className="flex gap-5">
            <a href="https://www.facebook.com/" className="text-[#999] hover:text-[#2054a8] transition" title="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/" className="text-[#999] hover:text-[#2054a8] transition" title="Instagram">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://line.me/" className="text-[#999] hover:text-[#2054a8] transition" title="LINE">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.youtube.com/" className="text-[#999] hover:text-[#2054a8] transition" title="YouTube">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
              </svg>
            </a>
            <a href="#" className="text-[#999] hover:text-[#2054a8] transition" title="RSS">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
